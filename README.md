...
### Visual Sidebar
- One-click checkpoint, update, backup
...
3. Make some changes
4. Click "Checkpoint" and describe what you did
5. Click "Connect" to link to GitHub
6. Click "Backup" to save to cloud

### Daily workflow:
1. Open VS Code
2. Click "Update" to get any changes
3. Do your work
4. Click "Checkpoint" when you reach a milestone
...
- **Checkpoint** = "I tried something and here's what I learned"
- **Backup** = "Sharing my learning into the collective universe"
- **Update** = "Bringing the latest collective thinking into my work"
